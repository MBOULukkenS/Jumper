    ...
    internal partial class EM_SettingsEditor
    {
        ...
        void DrawToggleArrayElement(SP dialog, int elementIndex)
        {
            DrawArrayElement(dialog, elementIndex, "", MinTogglesCount,
                ...
                obj =>
                {
                    GUIContent shouldToggleContent = new GUIContent("Toggle Description", "Change description when toggle is updated.");
                    GUIContent shouldToggleOnDescriptionContent = new GUIContent("Toggle On Description",
                                                               "This description will be displayed if the toggle value is true.");
                    GUIContent shouldToggleOffDescriptionContent = new GUIContent("Description",
                                                                "This description will be displayed regardless of the toggle value.");
                    GUIContent offDescriptionContent = new GUIContent("Toggle Off Description",
                                                    "This description will be displayed if the toggle value is false.");

                    SerializedProperty title = obj.FindPropertyRelative("title");
                    ...
                    if (privacyFoldoutStates[key])
                    {
                        ...
                        SerializedProperty shouldToggle = obj.FindPropertyRelative("shouldToggleDescription");
                        EGL.PropertyField(shouldToggle, shouldToggleContent);

                        // On description.
                        SerializedProperty onDescription = obj.FindPropertyRelative("onDescription");
                        ...
                        {
                            SerializedProperty offDescription = obj.FindPropertyRelative("offDescription");
                              ...
                              Func<int> getSelectedIndex, Action<int> setSelectedIndex, Action<SP> drawInnerProperties)
        {
            ...
            GUIStyle deleteButtonStyle = GUIStyle.none;
            GUILayoutOption deleteButtonMinWidth = GUILayout.MaxWidth(E_SM.smallButtonWidth);
        ...
        {
            SerializedProperty id = toggle.FindPropertyRelative("id");
            SerializedProperty title = toggle.FindPropertyRelative("title");
            SerializedProperty onDescription = toggle.FindPropertyRelative("onDescription");
            SerializedProperty offDescription = toggle.FindPropertyRelative("offDescription");
            SerializedProperty interactable = toggle.FindPropertyRelative("interactable");
        ...
        {
            SerializedProperty id = button.FindPropertyRelative("id");
            SerializedProperty title = button.FindPropertyRelative("title");
            SerializedProperty interactable = button.FindPropertyRelative("interactable");
            SerializedProperty titleColor = button.FindPropertyRelative("titleColor");
            SerializedProperty backgroundColor = button.FindPropertyRelative("backgroundColor");
            SerializedProperty uninteractableTitleColor = button.FindPropertyRelative("uninteractableTitleColor");
            SerializedProperty uninteractableBackgroundColor = button.FindPropertyRelative("uninteractableBackgroundColor");
