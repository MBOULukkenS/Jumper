...
namespace EasyMobile.Editor
{
    public class SerializableDictionaryPropertyDrawer : PropertyDrawer
    {
        ...
        protected virtual float DrawKeyValueLineSimple(SerializedProperty keyProperty, SerializedProperty valueProperty, string keyLabel, string valueLabel, Rect linePosition)
        {
            ...
            Rect keyPropertyPosition = new Rect(keyPosition.position + KeyLabelSize, keyPosition.size - KeyLabelSize);
            ...
            Rect valuePropertyPosition = new Rect(valuePosition.position + ValueLabelSize, valuePosition.size - ValueLabelSize);
        ...
        static SerializableDictionaryPropertyDrawer()
        {
            ...
            foreach (KeyValuePair<SerializedPropertyType, string> pair in serializedPropertyValueAccessorsNameDict)
            {
