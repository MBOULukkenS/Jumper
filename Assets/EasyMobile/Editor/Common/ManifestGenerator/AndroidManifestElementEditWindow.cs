...
namespace EasyMobile.Editor
{
    public class AndroidManifestElementEditWindow : EditorWindow
    {
        ...
        public static void ShowWindow(SerializedProperty generatableManifestProperty, SerializedProperty manifestElementsFactory)
        {
            ...
            AndroidManifestElementEditWindow window = GetWindow<AndroidManifestElementEditWindow>(/*new Type[] { inspectorType }*/);

            GeneratableAndroidManifest generatableManifest = generatableManifestProperty.GetTargetObject() as GeneratableAndroidManifest;
        ...
        private void DrawChildElementsGUI()
        {
            ...
            {
                string message = EditingElement.Style.ToAndroidManifestFormat() + " element can't contains any child element.";
        ...
        private void DrawAddChildElementGUI()
        {
            ...
            if (GUILayout.Button(plusContent, miniButtonStyle))
            {
                AndroidManifestElement element = EditingElement.ChildStyles.ToArray()[selectedElementStyleIndex].CreateElementClass();
        ...
        {
            List<AndroidManifestElement> childElements = target.GetChildElements(ManifestElementsFactory);
            ...
            for (int i = 0; i < childElements.Count; i++)
            {
                ...
                AndroidManifestElement childElement = childElements[i];
