...
namespace EasyMobile.Editor
{
    public class KeyValuePairDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            Rect idLabelRect = new Rect(position.x, position.y, keyLabelWidth, position.height);
            Rect idValueRect = new Rect(position.x + keyLabelWidth, position.y, valueWidth, position.height);
            Rect nameLabelRect = new Rect(position.x + keyLabelWidth + valueWidth, position.y, valueLabelWidth, position.height);
            Rect nameValueRect = new Rect(position.x + keyLabelWidth + valueWidth + valueLabelWidth, position.y, valueWidth, position.height);
