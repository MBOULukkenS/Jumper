...
namespace EasyMobile.Editor
{
    ...
    internal partial class EM_SettingsEditor
    {
        ...
        private void GenerateAdIdsConstants()
        {
            ...
            {
                AdColonySettings adColonySettings = AdProperties.adColonySettings.GetTargetObject() as AdColonySettings;
            ...
            {
                AdMobSettings admobSettings = AdProperties.admobSettings.GetTargetObject() as AdMobSettings;
            ...
            {
                AudienceNetworkSettings fbAudienceSettings = AdProperties.fbAudienceSettings.GetTargetObject() as AudienceNetworkSettings;
            ...
            {
                MoPubSettings mopubSettings = AdProperties.mopubSettings.GetTargetObject() as MoPubSettings;
            ...
            {
                TapjoySettings tapjoySettings = AdProperties.tapjoySettings.GetTargetObject() as TapjoySettings;
            ...
            {
                Hashtable hashtable = new Hashtable(finalResult);
                                                                ...
                                                                string sourceName)
        {
            ...
            foreach (KeyValuePair<AdPlacement, AdId> pair in source)
            {
        ...
        void DrawMediationSettingProperty(SerializedProperty property, string displayName)
        {
            ...
            {
                EditorGUILayout.BeginVertical(EditorStyles.helpBox);
                SerializedProperty setting = property.GetArrayElementAtIndex(i);
                                          ...
                                          Predicate<SerializedProperty> addCondition = null, Predicate<SerializedProperty> removeCondition = null, bool drawAsFoldout = false)
        {
            ...
            if (isFoldOut)
            {
                ...
                float plusButtonWidth = buttonStyle.CalcSize(plusContent).x;
                float minusButtonWidth = buttonStyle.CalcSize(minusContent).x;

                Rect minusPosition = new Rect(linePosition);
                ...
                Rect plusPosition = new Rect(linePosition);
