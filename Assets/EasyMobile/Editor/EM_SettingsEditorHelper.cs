...
namespace EasyMobile.Editor
{
    internal partial class EM_SettingsEditor
    {
        ...
        private void DrawUppercaseSection(string key, string sectionName, Action drawer, Action disableModule, Action enableModule, SerializedProperty triggerProperty, Texture2D sectionIcon = null)
        {
            ...
            Rect iconRect = new Rect(buttonRect.x + buttonRect.width - ChevronIconWidth - ChevronIconRightMargin, buttonRect.y, ChevronIconWidth, buttonRect.height);
        ...
        private bool DrawUppercaseSectionWithToggle(string key, string sectionName, bool toggle, Action drawer, Texture2D sectionIcon = null)
        {
            ...
            float toogleX = headerRect.x + EditorGUIUtility.currentViewWidth - 100;
            Rect toggleRect = new Rect(toogleX, headerRect.y - 2, 40, 24);
            bool result = EditorGUI.Toggle(toggleRect, toggle, EM_GUIStyleManager.GetCustomStyle("Module Toggle"));
        ...
        {
            List<AndroidPermission> modulePermissions = EM_PluginManager.GetAndroidPermissionsRequiredByModule(module);
            ...
            DrawUppercaseSection("ANDROID_PERMISSIONS_MODULE_" + module, "REQUIRED ANDROID PERMISSIONS", () =>
                {
                    ...
                    foreach (AndroidPermission permission in modulePermissions)
        ...
        {
            List<iOSInfoPlistItem> modulePlistItems = EM_PluginManager.GetIOSInfoItemsRequiredByModule(module);
            ...
            DrawUppercaseSection("IOS_USAGE_DESCRIPTIONS_EDITABLE_" + module, "REQUIRED IOS INFO.PLIST KEYS", () =>
                {
                    ...
                    foreach (iOSInfoPlistItem item in modulePlistItems)
        ...
        private void DrawIOSInfoPlistItemsRequiredSubsection(List<iOSInfoPlistItem> plistItems, GUIContent label = null, GUIStyle labelStyle = null)
        {
            ...
            foreach (iOSInfoPlistItem item in plistItems)
                DrawEditableIOSInfoPlistItem(item);
        }
        ...
        static void DrawArrayProperty(SerializedProperty property, Func<SerializedProperty, bool> elementDrawer)
        {
            ...
            for (int i = 0; i < property.arraySize; i++)
            {
                ...
                ArrayItemToolboxButtonResults buttonResults = new ArrayItemToolboxButtonResults();
