            ...
            DrawUppercaseSection(AndroidPermissionGUIKey, "REQUIRED ANDROID PERMISSIONS", () =>
                {
                    ...
                    foreach (KeyValuePair<Module, List<AndroidPermission>> pair in EM_PluginManager.GetAllAndroidPermissionsRequired())
            ...
            DrawUppercaseSection(IOSUsageDescriptionGUIKey, "REQUIRED IOS INFO.PLIST KEYS", () =>
                {
                    ...
                    foreach (KeyValuePair<Module, List<iOSInfoPlistItem>> pair in EM_PluginManager.GetAllIOSInfoItemsRequired())
