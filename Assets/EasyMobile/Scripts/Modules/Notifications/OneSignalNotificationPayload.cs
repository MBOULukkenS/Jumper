...
namespace EasyMobile
{
    public class OneSignalNotificationPayload
    {
        ...
        public static OneSignalNotificationPayload FromJSONDict(string id, Dictionary<string, object> jsonDict)
        {
            ...
            OneSignalNotificationPayload payload = new OneSignalNotificationPayload();

            payload.notificationID = id;

            if (jsonDict.ContainsKey("aps"))
            {
                Dictionary<string, object> aps = jsonDict["aps"] as Dictionary<string, object>;
                ...
                {
                    Dictionary<string, object> alert = aps["alert"] as Dictionary<string, object>;
            ...
            {
                Dictionary<string, object> custom = jsonDict["custom"] as Dictionary<string, object>;
            ...
            if (jsonDict.ContainsKey("buttons"))
            {
                ...
                List<object> buttons = jsonDict["buttons"] as List<object>;
                ...
                if (buttons != null)
                {
                    ...
                    {
                        Dictionary<string, object> btnDict = btn as Dictionary<string, object>;
