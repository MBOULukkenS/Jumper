...
namespace EasyMobile.Internal.Privacy
{
    ...
    public class EditorConsentDialogClickableText : Text, IPointerClickHandler, IPointerExitHandler, IPointerEnterHandler, ISelectHandler
    {
        ...
        public void OnPointerClick(PointerEventData eventData)
        {
            ...
            foreach (HrefInfo hrefInfo in hrefInfos)
            {
        ...
        protected void UpdateQuadImage()
        {
            ...
            foreach (Match match in regex.Matches(outputText))
            {
                ...
                Image img = imagesPool[imagesVertexIndex.Count - 1];
            ...
            for (int i = imagesVertexIndex.Count; i < imagesPool.Count; i++)
            {
                if (imagesPool[i])
                {
        ...
        protected override void OnPopulateMesh(VertexHelper toFill)
        {
            ...
            for (int i = 0; i < imagesVertexIndex.Count; i++)
            {
                int endIndex = imagesVertexIndex[i];
                RectTransform rt = imagesPool[i].rectTransform;
