...
namespace EasyMobile
{
    ...
    public class ConsentDialog
    {
        ...
        public void AppendToggle(Toggle toggle)
        {
            ...
            {
                List<Toggle> list = new List<Toggle>(Toggles);
                list.Add(toggle);
        ...
        public void AppendButton(Button button)
        {
            ...
            {
                List<Button> list = new List<Button>(ActionButtons);
                list.Add(button);
        ...
        {
            Regex match = new Regex(UrlPattern);
            MatchCollection matches = match.Matches(Content);
        ...
        private List<string> GetAllPatternsInContent()
        {
            ...
            {
                foreach (KeyValuePair<int, string> item in IndexesOf(Content, pattern))
                {
        ...
        {
            CompletedResults results = new CompletedResults();
