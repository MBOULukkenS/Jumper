...
namespace EasyMobile
{
    ...
    [AddComponentMenu("Easy Mobile/Recorder"), RequireComponent(typeof(UnityEngine.Camera)), DisallowMultipleComponent]
    public sealed class Recorder : MonoBehaviour
    {
        ...
        UnityEngine.Camera _targetCamera;
        int maxFrameCount;
        float pastTime;
        float timePerFrame;
        ...
        public static int CalculateAutoHeight(int width, UnityEngine.Camera targetCam)
        {
        ...
        public AnimatedClip Stop()
        {
            ...
            AnimatedClip clip = new AnimatedClip(_width, _height, _framePerSecond, recordedFrames.ToArray());
        ...
        void FlushMemory()
        {
            ...
            {
                foreach (RenderTexture rt in recordedFrames)
                {
                    rt.Release();
                    Flush(rt);
                }
