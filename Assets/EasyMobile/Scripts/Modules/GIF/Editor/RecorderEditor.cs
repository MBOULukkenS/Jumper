...
namespace EasyMobile.Editor
{
    ...
    public sealed class RecorderEditor : UnityEditor.Editor
    {
        ...
        UnityEngine.Camera attachedCam;
        ...
        void OnEnable()
        {
            ...
            attachedCam = ((Recorder)serializedObject.targetObject).GetComponent<UnityEngine.Camera>();
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                height.intValue = Recorder.CalculateAutoHeight(width.intValue, (UnityEngine.Camera)attachedCam);
