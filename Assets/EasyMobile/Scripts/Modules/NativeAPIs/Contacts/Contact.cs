    ...
    public class Contact
    {
        ...
        public KeyValuePair<string, string>[] PhoneNumbers
        {
            get
            {
                ...
                IEnumerable<KeyValuePair<string, string>> pairs = phoneNumbers.ToKeyValuePairs();
                if (pairs == null)
                    return null;
            ...
            internal set
            {
                ...
                IEnumerable<SerializableKeyValuePair<string, string>> pairs = value.ToSerializableKeyValuePairs();
                if (pairs == null)
                {
                    phoneNumbers = null;
                    return;
        ...
        public KeyValuePair<string, string>[] Emails
        {
            get
            {
                ...
                IEnumerable<KeyValuePair<string, string>> pairs = emails.ToKeyValuePairs();
                if (pairs == null)
                    return null;
