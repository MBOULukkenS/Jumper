    ...
    public class Stepper : UIBehaviour
    {
        ...
        private void RecreateSprites(Selectable[] sides)
        {
            for (int i = 0; i < 2; i++)
            {
                ...
                StepperSide side = sides[i].GetComponent<StepperSide>();
                if (side)
                {
        ...
        public void LayoutSides(Selectable[] sides = null)
        {
            ...
            for (int i = 0; i < 2; i++)
            {
                ...
                RectTransform rectTransform = sides[i].GetComponent<RectTransform>();
...
// TODO: maybe adjust text position
            ...
            if (separator)
            {
                Transform sepTransform = gameObject.transform.Find("Separator");
