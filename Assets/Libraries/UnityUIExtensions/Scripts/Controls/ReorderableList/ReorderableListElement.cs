...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ReorderableListElement : MonoBehaviour, IDragHandler, IBeginDragHandler, IEndDragHandler
    {
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            Canvas canvas = _draggingObject.GetComponentInParent<Canvas>();
            Vector3 worldPoint;
            ...
            else
            {
                ...
                {
                    RectTransform c = _currentReorderableListRaycasted.Content.GetChild(j).GetComponent<RectTransform>();
        ...
        private void displaceElement(int targetIndex, Transform displaced)
        {
            ...
            ReorderableList.ReorderableListEventStruct args = new ReorderableList.ReorderableListEventStruct
            {
        ...
        private void RefreshSizes()
        {
            ...
            {
                Transform firstChild = _currentReorderableListRaycasted.Content.GetChild(0);
                if (firstChild != null)
                {
