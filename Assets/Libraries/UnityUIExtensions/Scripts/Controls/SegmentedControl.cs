    ...
    public class SegmentedControl : UIBehaviour
    {
        ...
        public int selectedSegmentIndex
        {
            ...
            set
            {
                ...
                if (selectedSegment)
                {
                    Segment segment = selectedSegment.GetComponent<Segment>();
                    if (segment)
                    {
        ...
        {
            Selectable[] buttons = GetComponentsInChildren<Selectable>();
            if (buttons.Length < 2)
            {
            ...
            {
                Segment segment = buttons[i].GetComponent<Segment>();
                if (segment != null)
                {
                    segment.index = i;
        ...
        private void RecreateSprites()
        {
            for (int i = 0; i < segments.Length; i++)
            {
                ...
                Segment segment = segments[i].GetComponent<Segment>();
                if (segment)
                {
        ...
        public void LayoutSegments()
        {
            ...
            for (int i = 0; i < segments.Length; i++)
            {
                ...
                RectTransform rectTransform = segments[i].GetComponent<RectTransform>();
                ...
                if (separator && i > 0)
                {
                    Transform sepTransform = gameObject.transform.Find("Separator " + i);
