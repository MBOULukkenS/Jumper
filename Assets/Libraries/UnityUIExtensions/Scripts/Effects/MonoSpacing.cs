    ...
    public class MonoSpacing : BaseMeshEffect
	{
        ...
        public override void ModifyMesh(VertexHelper vh)
        {
			...
			for (int lineIdx=0; lineIdx < lines.Length; lineIdx++)
			{
                ...
                float offsetX = -lineOffset + letterOffset / 2 * (1 - alignmentFactor * 2);
				...
				for (int charIdx = 0; charIdx < line.Length; charIdx++)
				{
                    ...
                    bool smallChar = UseHalfCharWidth && (charWidth < HalfCharWidth);

                    float smallCharOffset = smallChar ? -letterOffset/4 : 0;
