...
namespace UnityEngine.UI.Extensions
{
	...
	public Boolean UseTimeScale = true;
        ...
        void Awake()
        {
            ...
            {
                ScrollSnapScrollbarHelper hscroll = _scroll_rect.horizontalScrollbar.gameObject.AddComponent<ScrollSnapScrollbarHelper>();
                hscroll.ss = this;
            }
            if (_scroll_rect.verticalScrollbar && _scroll_rect.vertical)
            {
                ScrollSnapScrollbarHelper vscroll = _scroll_rect.verticalScrollbar.gameObject.AddComponent<ScrollSnapScrollbarHelper>();
                vscroll.ss = this;
            }
        ...
        private void OnValidate()
        {
            ...
            RectTransform ScrollRectContent = gameObject.GetComponent<ScrollRect>().content;
            if (ScrollRectContent != null)
            {
                int children = ScrollRectContent.childCount;
