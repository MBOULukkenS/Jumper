...
namespace UnityEngine.UI.Extensions
{
    ...
    public class VerticalScrollSnap : ScrollSnapBase, IEndDragHandler
    {
        ...
        public void DistributePages()
        {
            ...
            float pageStepValue = _childSize = (int)panelDimensions.height * ((PageStep == 0) ? 3 : PageStep);
        ...
        {
            int _screenCount = _screensContainer.childCount;
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            ...
            {
                float distance = Vector3.Distance(_startPosition, _screensContainer.localPosition);
                if(UseHardSwipe){
