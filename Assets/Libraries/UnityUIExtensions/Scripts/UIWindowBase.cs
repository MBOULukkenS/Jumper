...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UIWindowBase : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        ...
        public void OnDrag(PointerEventData eventData)
        {
            if (_isDragging)
            {
                Vector3 delta = ScreenToCanvas(eventData.position) - ScreenToCanvas(eventData.position - eventData.delta);
        ...
        private Vector3 ScreenToCanvas(Vector3 screenPosition)
        {
            ...
            Vector2 min;
            Vector2 max;
            Vector2 canvasSize = m_canvasRectTransform.sizeDelta;
            ...
            else
            {
                ...
                Plane plane = new Plane(m_canvasRectTransform.forward, m_canvasRectTransform.position);
