...
namespace Doozy.Engine.Layouts
{
    ...
    public class RadialLayout : LayoutGroup
    {
        ...
        {
            GameObject go = new GameObject(MenuUtils.RadialLayout_GameObject_Name, typeof(RectTransform), typeof(RadialLayout));
...
//#endif
        ...
        public void CalculateRadial()
        {
            ...
            for (int i = 0; i < transform.childCount; i++)
            {
                ...
                UIButton childButton = child.GetComponent<UIButton>();
                if (childButton != null) childButton.UpdateStartValues();

                UIToggle childToggle = child.GetComponent<UIToggle>();
            ...
            foreach (RectTransform child in m_childList)
            {
                ...
                Vector3 vPos = new Vector3(Mathf.Cos(fAngle * Mathf.Deg2Rad), Mathf.Sin(fAngle * Mathf.Deg2Rad), 0); //calculate the child position
