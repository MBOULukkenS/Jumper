...
#if UNITY_EDITOR
                ListOfNames listOfNames = AssetUtils.CreateAsset<ListOfNames>(GetPath(DatabaseType), GetDatabaseFileName(DatabaseType, GENERAL));
#else
...
#if UNITY_EDITOR
            ListOfNames listOfNames = AssetUtils.CreateAsset<ListOfNames>(GetPath(DatabaseType), GetDatabaseFileName(DatabaseType, categoryName));
#else
            ListOfNames listOfNames = ScriptableObject.CreateInstance<ListOfNames>();
#endif
