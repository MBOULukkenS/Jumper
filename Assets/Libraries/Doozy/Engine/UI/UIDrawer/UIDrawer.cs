...
namespace Doozy.Engine.UI
{
    ...
    public class UIDrawer : UIComponentBase<UIDrawer>, IDragHandler, IBeginDragHandler, IEndDragHandler
    {
        ...
        {
            GameObject go = new GameObject(MenuUtils.UIDrawer_GameObject_Name, typeof(RectTransform), typeof(UIDrawer));
            ...
            UIDrawer drawer = go.GetComponent<UIDrawer>();
            ...
            RectTransform arrowContainerRectTransform = arrowContainer.GetComponent<RectTransform>();
            ...
            foreach (SimpleSwipe swipe in Enum.GetValues(typeof(SimpleSwipe)))
            {
                ...
                GameObject root = new GameObject(swipe.ToString(), typeof(RectTransform));
                ...
                GameObject closed = new GameObject("ClosedPosition", typeof(RectTransform));
                GameObjectUtility.SetParentAndAlign(closed, root);
                RectTransform closedRectTransform = closed.GetComponent<RectTransform>();
                UIDrawerArrow.ResetArrowClosedPosition(closedRectTransform, swipe);

                GameObject opened = new GameObject("OpenedPosition", typeof(RectTransform));
                GameObjectUtility.SetParentAndAlign(opened, root);
                RectTransform openedRectTransform = opened.GetComponent<RectTransform>();
            ...
            GameObject arrow = new GameObject("Arrow", typeof(RectTransform), typeof(UIDrawerArrowAnimator));
            GameObjectUtility.SetParentAndAlign(arrow, arrowContainer);
            arrow.GetComponent<RectTransform>().Center(true);
            arrow.transform.localPosition = Vector3.zero;
            UIDrawerArrowAnimator animator = arrow.GetComponent<UIDrawerArrowAnimator>();
            ...
            RectTransform rotatorRectTransform = rotator.GetComponent<RectTransform>();
            ...
            RectTransform leftBarRectTransform = leftBar.GetComponent<RectTransform>();
            ...
            RectTransform rightBarRectTransform = rightBar.GetComponent<RectTransform>();
