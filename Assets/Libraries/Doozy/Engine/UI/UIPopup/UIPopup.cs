...
namespace Doozy.Engine.UI
{
    ...
    public class UIPopup : UIComponentBase<UIPopup>
    {
        ...
        {
            GameObject go = new GameObject(MenuUtils.UIPopup_GameObject_Name, typeof(RectTransform), typeof(UIPopup));
            ...
            GameObject container = new GameObject("Container", typeof(RectTransform), typeof(Canvas), typeof(GraphicRaycaster), typeof(CanvasGroup), typeof(Image));
        ...
        {
#if dUI_TextMeshPro
            GameObject label = new GameObject(labelName, typeof(RectTransform));
            GameObjectUtility.SetParentAndAlign(label, parent);

            TextMeshProUGUI textMeshProLabel = label.AddComponent<TextMeshProUGUI>();
        ...
        public static GameObject CreateTextLabel(string labelName, string labelText, GameObject parent)
        {
            ...
            Text textLabel = label.AddComponent<Text>();
