...
namespace Doozy.Engine.UI.Animation
{
    ...
    public class UIAnimations : ScriptableObject
    {
        ...
        {
#if UNITY_EDITOR
            UIAnimationDatabase database = AssetUtils.CreateAsset<UIAnimationDatabase>(Path.Combine(DoozyPath.UIANIMATIONS_RESOURCES_PATH, databaseType.ToString()), newPresetCategory, ".asset", false, false);
#else
