...
namespace Doozy.Editor.Drawers
{
    ...
    public class AnimatorEventDrawer : BaseDrawer
    {
        ...
        private void UpdateParameters(SerializedProperty property)
        {
            ...
            Animator anim = (Animator) animator.objectReferenceValue;
        ...
        private void DrawParameterSelector(Rect drawRect, SerializedProperty property, AnimatorControllerParameter[] parameters, List<string> parameterNames, bool hasAnimator, bool hasController)
        {
            if (parameterNames.Count > 0)
            {
                ...
                Rect parameterTypeNameRect = new Rect(drawRect.x + DGUI.Properties.StandardVerticalSpacing, drawRect.y, parameterTypeNameLabelWidth, DGUI.Properties.SingleLineHeight);
                DGUI.Label.Draw(parameterTypeNameRect, parameterTypeName, Size.M);

                Rect selectorRect = new Rect(drawRect.x + parameterTypeNameLabelWidth, drawRect.y + 1, drawRect.width - parameterTypeNameLabelWidth - DGUI.Properties.StandardVerticalSpacing, DGUI.Properties.SingleLineHeight);
            ...
            {
                Rect labelRect = new Rect(drawRect.x + DGUI.Properties.StandardVerticalSpacing, drawRect.y, drawRect.width - DGUI.Properties.StandardVerticalSpacing, DGUI.Properties.SingleLineHeight);
