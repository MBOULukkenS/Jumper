...
namespace Doozy.Editor.UI.Nodes
{
    ...
    public class LoadSceneNodeGUI : BaseNodeGUI
    {
        ...
        private void DrawActionDescription()
        {
            ...
            Rect loadSceneModeRect = new Rect(x, DynamicHeight, DrawRect.width - 32, lineHeight);
            DynamicHeight += loadSceneModeRect.height;
            Rect sceneNameOrBuildIndexModeRect = new Rect(x, DynamicHeight, DrawRect.width - 32, lineHeight);
            DynamicHeight += sceneNameOrBuildIndexModeRect.height;
            Rect allowSceneActivationModeRect = new Rect(x, DynamicHeight, DrawRect.width - 32, lineHeight);
            DynamicHeight += allowSceneActivationModeRect.height;
            Rect sceneActivationDelayModeRect = new Rect(x, DynamicHeight, DrawRect.width - 32, lineHeight);
