    ...
    public class InfoMessage
    {
        ...
        public static void Draw(InfoMessage infoMessage, float width)
        {
            ...
            if (DGUI.FadeOut.Begin(infoMessage.Show.faded, false))
            {
                ...
                GUIContent titleContent = new GUIContent(string.IsNullOrEmpty(infoMessage.Title) ? GetTitleText(infoMessage.Type) : infoMessage.Title);
                GUIContent messageContent = new GUIContent(infoMessage.Message);
