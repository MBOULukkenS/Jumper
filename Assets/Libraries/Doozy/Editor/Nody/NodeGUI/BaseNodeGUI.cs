...
namespace Doozy.Editor.Nody.NodeGUI
{
    ...
    public abstract class BaseNodeGUI : NodeGUIBase<BaseNodeGUI, BaseNodeGUI.CustomNodeGUI, Node>
    {
        ...
        public Rect DeleteButtonRect
        {
            get
            {
                Vector2 buttonPosition = new Vector2(X + Width - m_deleteButtonSize.x / 2 - 6f,
...
//            m_dynamicHeight = node.GetHeight();
        ...
        public void DrawNodeGUI(Rect graphArea, Vector2 panOffset, float zoomLevel)
        {
            ...
            Rect clientRect = new Rect(windowToGridPosition, m_node.GetSize());
        ...
        protected void DrawNodeBody()
        {
            ...
            if (Node.DebugMode)
            {
                ...
                Rect debugIconRect = new Rect(m_headerRect.xMax - HeaderIconPadding * 2 - debugModeIconSize,
...
//            if (Event.current.alt)
            ...
            Rect topDividerRect = new Rect(socket.GetRect().x + 6,
            ...
            Rect bottomDividerRect = new Rect(socket.GetRect().x + 6,
            ...
            {
                Rect animatedRect = new Rect(socket.HoverRect.x,
        ...
        {
            Rect area = new Rect(6, DynamicHeight, Node.GetWidth() - 12, NodySettings.Instance.SocketHeight);
            ...
            Rect iconRect = new Rect(area.x + area.width / 2 - NodySettings.Instance.NodeAddSocketButtonSize / 2,
                                    area.y + area.height / 2 - NodySettings.Instance.NodeAddSocketButtonSize / 2,
                                    NodySettings.Instance.NodeAddSocketButtonSize,
                                    NodySettings.Instance.NodeAddSocketButtonSize);
            Rect hoveredIconRect = new Rect(iconRect.x - iconRect.width * 0.4f / 2,
...
//            }
        ...
        private void UpdateColors()
        {
            ...
            ColorName accentColorName = ColorName.Gray;
        ...
        {
            Color initialColor = GUI.color;
            Rect timerProgressBackgroundRect = new Rect(areaRect.x, areaRect.yMax - barHeight, areaRect.width, barHeight);
            ...
            {
                if (!alwaysVisible) GUI.Label(timerProgressBackgroundRect, GUIContent.none, DGUI.Properties.White);
                Rect timerProgressRect = new Rect(timerProgressBackgroundRect.x, timerProgressBackgroundRect.y, timerProgressBackgroundRect.width * timerProgress, timerProgressBackgroundRect.height);
