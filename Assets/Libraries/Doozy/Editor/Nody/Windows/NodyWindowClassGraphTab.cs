        ...
        private void DrawGraphTabs()
        {
            ...
            GUILayout.BeginHorizontal();
            {
                ...
                for (int index = 0; index < tabsCount; index++)
                {
                    ...
                    Rect buttonRect = new Rect(x, GraphTabsRect.y + NodySettings.Instance.GraphTabElementSpacing, tabWidth, GraphTabsRect.height - 2 * NodySettings.Instance.GraphTabElementSpacing);
