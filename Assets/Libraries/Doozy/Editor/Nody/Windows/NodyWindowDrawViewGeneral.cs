...
namespace Doozy.Editor.Nody.Windows
{
    public partial class NodyWindow
    {
        private void DrawViewGeneral()
        {
            ...
            Rect recentAreaRect = new Rect(graphArea.width - NodyWindowSettings.RECENT_GRAPHS_AREA_WIDTH, 0, NodyWindowSettings.RECENT_GRAPHS_AREA_WIDTH, graphArea.height);

            Rect splashArea = new Rect(graphArea.x + splashPadding + ToolbarWidth,
            ...
            Rect splashScreenRect = new Rect(x, y, width, height);
