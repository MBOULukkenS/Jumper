...
namespace Doozy.Editor.Nody.Windows
{
    public partial class NodyWindow
    {
        ...
        private void DrawViewGraph()
        {
            ...
            Rect graphArea = new Rect(0, 0, position.width, position.height);
...
//            return;
        ...
        private void DrawGraphMode(string modeName, Color modeColor, AnimBool showMode)
        {
            ...
            float size = 32;
            Rect topRect = new Rect(0, 0, position.width, size);
            Rect bottomRect = new Rect(0, position.height - size, position.width, size);
            Rect leftRect = new Rect(0, 0, size, position.height);
            Rect rightRect = new Rect(position.width - size, 0, size, position.height);
            ...
            GUIContent tempContent = new GUIContent(modeName);
            Vector2 titleSize = GUI.skin.box.CalcSize(tempContent);
            Rect titleRect = new Rect(position.width / 2 - titleSize.x / 2 - 8,
        ...
        private void DrawGraphName()
        {
            ...
            Rect graphNameRect = new Rect(6, 2, position.width, 32);
        ...
        {
            if (CurrentGraph == null) return;
            Rect bottomInfoBar = new Rect(0, position.height - 24, position.width, 24);
