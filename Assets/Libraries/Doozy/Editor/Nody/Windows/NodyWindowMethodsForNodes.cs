...
namespace Doozy.Editor.Nody.Windows
{
    public partial class NodyWindow
    {
        ...
        {
            Node copy = CreateInstance(node.GetType()) as Node;
//            DDebug.Log("node.GetType(): " + node.GetType().Name);
        ...
        private void PasteNodes()
        {
            ...
            List<Socket> copySockets = new List<Socket>();
            ...
            List<Connection> copyConnections = new List<Connection>();
            ...
            List<string> copiedNodesIds = new List<string>(); //create a list of all the copied nodes ids (list contains the newly generated ids)
            ...
            List<Node> nodesList = new List<Node>(copyNodes);
