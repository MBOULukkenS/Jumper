...
namespace Doozy.Editor.Nody.Windows
{
    public partial class NodyWindow
    {
        ...
        {
            GenericMenu menu = new GenericMenu(); //create a generic menu
...
//                if (ActiveSelection.Nodes.Count > 0)
            ...
            menu.AddSeparator("");
            GUIContent copyNode = new GUIContent(UILabels.Copy);
            GUIContent deleteNode = new GUIContent(UILabels.Delete);
        ...
        private void ShowGraphContextMenu()
        {
            ...
            List<NodeMenuItem> nodeMenus = new List<NodeMenuItem>();
...
//            }
            ...
            menu.AddSeparator("");
            GUIContent pasteNode = new GUIContent(UILabels.Paste);
