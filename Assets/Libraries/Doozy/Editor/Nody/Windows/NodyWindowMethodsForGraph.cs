...
//            Undo.CollapseUndoOperations(undoGroupIndex);
        ...
        {
            Graph graph = GraphUtils.CreateGraphWidthDialog<Graph>(createSubGraph);
...
//            Undo.SetCurrentGroupName(m_graphAssetName);
        ...
        public void OpenSubGraph(SubGraphNode subGraphNode)
        {
            ...
            GraphTab newTab = new GraphTab(CurrentGraph, subGraphNode, CurrentZoom, CurrentPanOffset, SelectedNodes, DeletedNodes);
