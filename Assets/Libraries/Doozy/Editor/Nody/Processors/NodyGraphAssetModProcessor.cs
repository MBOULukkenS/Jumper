...
namespace Doozy.Editor.Nody.Processors
{
    ...
    public class NodyGraphAssetModProcessor : UnityEditor.AssetModificationProcessor
    {
        ...
        private static AssetDeleteResult OnWillDeleteAsset(string assetPath, RemoveAssetOptions options)
        {
            ...
            Object loadAssetAtPath = AssetDatabase.LoadAssetAtPath<Object>(assetPath);
            ...
            MonoScript script = loadAssetAtPath as MonoScript;
        ...
        private static void OnReloadEditor()
        {
            ...
            foreach (string guid in guids)
            {
                ...
                Graph graph = AssetDatabase.LoadAssetAtPath(assetPath, typeof(Graph)) as Graph;
