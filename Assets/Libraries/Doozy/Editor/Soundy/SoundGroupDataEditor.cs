...
namespace Doozy.Editor.Soundy
{
    ...
    public class SoundGroupDataEditor : BaseEditor
    {
        ...
        private void DrawPlayer()
        {
            ...
            Rect playerRect = new Rect(lastRect.x + DGUI.Properties.Space(), lastRect.y, lastRect.width - DGUI.Properties.Space(2), DGUI.Properties.SingleLineHeight); //calculate player rect
