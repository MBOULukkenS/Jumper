...
namespace Doozy.Editor.Soundy
{
    ...
    public class SoundyDataDrawer : BaseDrawer
    {
        ...
        private void Draw(Rect position, SerializedProperty property)
        {
            ...
            SoundSource soundSource = (SoundSource) Properties.Get(PropertyName.SoundSource, property).intValue;
            switch (soundSource)
            {
        ...
        private void DrawSoundy(Rect drawRect, SerializedProperty property, bool hasSound, bool hasMissingAudioClips, bool nameIsNoSound, SoundyAudioPlayer.Player player, ColorName backgroundColorName, ColorName textColorName)
        {
            ...
            Rect outputLabelRect = new Rect(x, y, OUTPUT_LABEL_WIDTH, TOP_ROW_HEIGHT);
            ...
            Rect databaseNameLabelRect = new Rect(x, y, databaseNameSoundNameWidth, TOP_ROW_HEIGHT);
            x += databaseNameSoundNameWidth + DGUI.Properties.Space();
            Rect soundNameLabelRect = new Rect(x, y, databaseNameSoundNameWidth, TOP_ROW_HEIGHT);
            ...
            Rect outputDropdownRect = new Rect(x, y, OUTPUT_LABEL_WIDTH, DGUI.Properties.SingleLineHeight);
            x += OUTPUT_LABEL_WIDTH + DGUI.Properties.Space();
            Rect databaseNameDropdownRect = new Rect(x, y, databaseNameSoundNameWidth, DGUI.Properties.SingleLineHeight);
            x += databaseNameSoundNameWidth + DGUI.Properties.Space();
            Rect soundNameDropdownRect = new Rect(x, y, databaseNameSoundNameWidth, DGUI.Properties.SingleLineHeight);
            ...
            Rect openSoundyButtonRect = new Rect(x, y, OUTPUT_LABEL_WIDTH, DGUI.Properties.SingleLineHeight);
            x += OUTPUT_LABEL_WIDTH;
            x += DGUI.Properties.Space(2);
            Rect outputAudioMixerGroupIconRect = new Rect(x, y + (DGUI.Properties.SingleLineHeight - iconSize) / 2, iconSize, iconSize);
            x += outputAudioMixerGroupIconRect.width;
            x += DGUI.Properties.Space();
            Rect outputAudioMixerGroupLabelRect = new Rect(x, y, drawRect.width - OUTPUT_LABEL_WIDTH - outputAudioMixerGroupIconRect.width - DGUI.Properties.Space(5), DGUI.Properties.SingleLineHeight);
        ...
        private void DrawAudioClip(Rect drawRect, SerializedProperty property, bool hasSound, SoundyAudioPlayer.Player player, ColorName backgroundColorName, ColorName textColorName)
        {
            ...
            x += OUTPUT_LABEL_WIDTH + DGUI.Properties.Space();
            Rect audioClipLabelRect = new Rect(x, y, audioClipLabelWidth, TOP_ROW_HEIGHT);
            ...
            Rect outputDropdownRect = new Rect(x, y, OUTPUT_LABEL_WIDTH, DGUI.Properties.SingleLineHeight);
            x += OUTPUT_LABEL_WIDTH + DGUI.Properties.Space();
            Rect audioClipRect = new Rect(x, y, audioClipLabelWidth, DGUI.Properties.SingleLineHeight);
            ...
            GUIContent outputAudioMixerGroupContent = new GUIContent(UILabels.OutputAudioMixerGroup);
            ...
            x += iconSize;
            x += DGUI.Properties.Space();
            Rect outputAudioMixerGroupLabelRect = new Rect(x, y + (DGUI.Properties.SingleLineHeight - outputAudioMixerGroupContentSize.y) / 2, outputAudioMixerGroupContentSize.x, outputAudioMixerGroupContentSize.y);
            x += outputAudioMixerGroupContentSize.x;
            x += DGUI.Properties.Space(2);
            Rect outputAudioMixerGroupRect = new Rect(x, y, drawRect.width - DGUI.Properties.Space(6) - outputAudioMixerGroupIconRect.width - outputAudioMixerGroupLabelRect.width, DGUI.Properties.SingleLineHeight);
        ...
        private void DrawPlayer(Rect drawRect, float x, float y, bool hasSound, SoundyAudioPlayer.Player player, ColorName colorName)
        {
            ...
            {
                Rect playerRect = new Rect(x, y, drawRect.width - DGUI.Properties.Space(2), DGUI.Properties.SingleLineHeight + DGUI.Properties.Space(2));
            ...
            else
            {
                ...
                GUIContent messageContent = new GUIContent("Soundy Player - Not Available");
                Vector2 messageContentSize = DGUI.Label.Style(Size.S).CalcSize(messageContent);

                Rect iconRect = new Rect(x, y + (DGUI.Properties.SingleLineHeight - iconSize) / 2, iconSize, iconSize);
                x += iconRect.width;
                x += DGUI.Properties.Space();
                Rect messageRect = new Rect(x, y + (DGUI.Properties.SingleLineHeight - messageContentSize.y) / 2, messageContentSize.x, messageContentSize.y);
        ...
        private void DrawMasterAudio(Rect drawRect, SerializedProperty property, ColorName backgroundColorName, ColorName textColorName)
        {
            ...
            x += OUTPUT_LABEL_WIDTH + DGUI.Properties.Space();
            Rect soundNameLabelRect = new Rect(x, y, soundNameLabelWidth, TOP_ROW_HEIGHT);
            ...
            Rect outputDropdownRect = new Rect(x, y, OUTPUT_LABEL_WIDTH, DGUI.Properties.SingleLineHeight);
            x += OUTPUT_LABEL_WIDTH + DGUI.Properties.Space();
            Rect soundNameFieldRect = new Rect(x, y, soundNameLabelWidth, DGUI.Properties.SingleLineHeight);
            ...
            {
                Rect masterAudioIconRect = new Rect(soundNameFieldRect.x, soundNameFieldRect.y, soundNameFieldRect.height, soundNameFieldRect.height);
                DGUI.Icon.Draw(masterAudioIconRect, Styles.GetStyle(Styles.StyleName.IconMasterAudio));
                Rect buttonRect = new Rect(masterAudioIconRect.xMax + DGUI.Properties.Space(), masterAudioIconRect.y, soundNameFieldRect.width - masterAudioIconRect.width - DGUI.Properties.Space(), soundNameFieldRect.height);
