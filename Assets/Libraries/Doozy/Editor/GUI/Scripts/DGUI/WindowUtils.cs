    ...
    public static partial class DGUI
    {
        public static class WindowUtils
        {
            ...
            public static void DrawSettingDescription(string description)
            {
                ...
                GUIStyle textStyle = new GUIStyle(Label.Style(Size.S, TextAlign.Left, Colors.DisabledTextColorName));Label.Style(Size.S, TextAlign.Left, Colors.DisabledTextColorName);
